        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('gambar.update',$gambar->id)}}" class="" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('storage/img/'.$gambar->path) }}" style="margin-bottom:2rem;" class="" width="200" alt="">
                            </div>
                            <div class="row mb-3">
                                <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('Name') }}</label>

                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $gambar->name }}" required autocomplete="name" autofocus>
                            ...
                            <div class="row mb-3">
                                <label for="path" class="col-md-4 col-form-label text-md-end">{{ __('Upload Gambar') }}</label>

                                <div class="col-md-6">
                                    <input id="path" type="file" class="form-control @error('path') is-invalid @enderror" name="path" value="{{ $gambar->path }}" autocomplete="path">
