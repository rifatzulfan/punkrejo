        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('produk.update',$produk->id)}}" class="" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('storage/img/'.$produk->path) }}" style="margin-bottom:2rem;" class="" width="200" alt="">
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="price" type="text" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ $produk->price }}" required autocomplete="name" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="hari" type="text" class="form-control @error('hari') is-invalid @enderror" name="hari" value="{{ $produk->hari }}" required autocomplete="hari" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="jam" type="text" class="form-control @error('jam') is-invalid @enderror" name="jam" value="{{ $produk->jam }}" required autocomplete="name" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="desc" type="text" class="form-control @error('desc') is-invalid @enderror" name="desc" value="{{ $produk->desc }}" required autocomplete="desc" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="path" type="file" class="form-control @error('path') is-invalid @enderror" name="path" value="{{ $produk->path }}" autocomplete="path">
